...
export class UserAddFavorite1693407826151 implements MigrationInterface {
    name = 'UserAddFavorite1693407826151'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "users_favorites_article" ADD CONSTRAINT "FK_a1c47e316b5fca0cafbccba8481" FOREIGN KEY ("usersId") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "users_favorites_article" ADD CONSTRAINT "FK_a3bfc382dd3fbe65031c2cf7e61" FOREIGN KEY ("articleId") REFERENCES "article"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    }
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`COMMENT ON COLUMN "article"."updateAt" IS NULL`);
        await queryRunner.query(`COMMENT ON COLUMN "article"."createdAt" IS NULL`);
        await queryRunner.query(`DROP INDEX "IDX_a3bfc382dd3fbe65031c2cf7e6"`);
        await queryRunner.query(`DROP INDEX "IDX_a1c47e316b5fca0cafbccba848"`);
